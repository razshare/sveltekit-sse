 ...
 * @property {T|null} previous This is the previous value of the store.
 */
...
/**
 * @typedef {<T = any>(or?:import('./types.external').JsonPredicate<T>)=>import('svelte/store').Readable<T extends null ? T|undefined : T>} Jsonifier
 */
...
/**
 * @typedef {<T>(transformer:Transformer<T|null>) => import('svelte/store').Readable<T|null>} SourceSelectedTransform
 */

/**
 * @typedef SourceSelected
 * @property {SourceSelectedTransform} transform Transform the data into a custom shape.
 * @property {Jsonifier} json Parse the data as json.
 */

/**
 * @callback SourceSelect
 * @param {string} eventName Name of the event.
 * @returns {import('svelte/store').Readable<string>&SourceSelected}
 */
